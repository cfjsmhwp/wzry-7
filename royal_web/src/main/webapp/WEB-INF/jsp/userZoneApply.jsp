        ...
        <div class="user-info clearfix">
            ...
            <div class="user-info-r r">
                <ul class="clearfix hd">
                    ...
                    <c:if test="${loginUser.role==2}"><li class="cur"><a href="${pageContext.request.contextPath}/user/getUser.do?method=userZoneApply">开辟新版块</a></li></c:if>
                </ul>
                ...
                <form id="zoneApplyForm" action="#" method="post" >
                    <ul class="bd">
                        <li class="clearfix">
                            ...
                            <div><input type="hidden" name="userName" value="${loginUser.userName}"></div>
                        </li>
                        <li class="clearfix">
...
$(function () {
    $("#zoneApply").click(function () {
        if ($("#zoneName").val()&&$("#reason").val()){
            $.post("${pageContext.request.contextPath}/zone/apply.do",$("#zoneApplyForm").serialize(),function (data) {
