                ...
                <form id="userPwdForm" action="#" method="post">
                  <ul class="bd">
                    <li class="clearfix">
                        ...
                        <div class="info-r"><input type="hidden" name="userName" value="${user.userName}" class="txt"/></div>
                    </li>
                    <li class="clearfix">
    ...
    $(function(){
        ...
        $("#sub_btn").click(function () {
            if ($("#newPassword").val()!=$("#confirmPassword").val()) {
                ...
                $.post("${pageContext.request.contextPath}/user/updatePwd",$("#userPwdForm").serialize(),function (data) {
