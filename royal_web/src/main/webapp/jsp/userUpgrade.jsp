        ...
        <div class="user-info clearfix">
            ...
            <div class="user-info-r r">
                <ul class="clearfix hd">
                    ...
                    <c:if test="${user.role==1}"><li class="cur"><a href="${pageContext.request.contextPath}/jsp/userUpgrade.jsp">申请高级用户</a></li></c:if>
                    <c:if test="${user.role==2}"><li><a href="${pageContext.request.contextPath}/jsp/userZoneApply.jsp">开辟新版块</a></li></c:if>
                </ul>
                ...
                <form action="#" method="post" >
                    <ul class="bd">
                        <li class="clearfix">
                            ...
                            <div class="info-r"><input type="text"  class="txt" value="开辟新板块" readonly="readonly"/></div>
                        </li>
                        <li class="clearfix">
                            <div class="info-l red">申请条件：</div>
                            <div class="info-r"><input type="text" name="email" class="txt" value="发帖数≥5"/></div>
                        </li>
                        <li class="clearfix">
...
$(function () {
    ...
    $("#apply").click(function () {
        if ($("#getArticleCount").html()>=5){
            $.post("${pageContext.request.contextPath}/user/applyUpgrade",{"userName":"zhangsan"},function (data) {
                if (data==1){
                    alert("申请成功！")
                }
            },"json")
    ...
    $.ajax({
        type:"post",
        url:"${pageContext.request.contextPath}/article/getTotalCount",
