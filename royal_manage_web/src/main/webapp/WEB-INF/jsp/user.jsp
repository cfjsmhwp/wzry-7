                        ...
                        <c:forEach items="${userList}" var="user">
                            ...
                            <tr>
                                ...
                                <td width="15%">
                                    ...
                                    <a href="/article/deleteArticle.do?id=${article.articleid}&pn=${articleMsgs.pageNum}&title=${articleSearch.title}&sendername=${articleSearch.sendername}" role="button" class="btn btn-primary">禁言</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
