            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <!--首页-->
                            <li><a href="${pageContext.request.contextPath}/zoneApply/findAll.do?pageNum=1&pageSize=${pageInfo.pageSize}" >首页</a></li>
                            <!--上一页-->
                            <li>
                                <a href="${pageContext.request.contextPath}/zoneApply/findAll.do?pageNum=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}"  aria-label="Previous">
                                    <span aria-hidden="true">«</span>
                                </a>
                            </li>

                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                <li><a href="${pageContext.request.contextPath}/zoneApply/findAll.do?pageNum=${pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a></li>
                            </c:forEach>

                            <!--下一页-->
                            <li>
                                <a href="${pageContext.request.contextPath}/zoneApply/findAll.do?pageNum=${pageInfo.pageNum+1}&pageSize=${pageInfo.pageSize}"
                                   aria-label="Next">
                                    <span aria-hidden="true">»</span>
                                </a>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/zoneApply/findAll.do?pageNum=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" >尾页</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
